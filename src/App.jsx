...
const IMPORT_FIELDS = [
  ...
  { key:"totalDue",        label:"Total Show Cost", aliases:["cost","total cost","total show cost","show cost","total due","price","fee","amount","total"] },
  { key:"depositDue",      label:"Deposit Due",     aliases:["deposit due","deposit amount due"] },
  { key:"depositPaid",     label:"Deposit Paid",    aliases:["deposit paid","deposit amt","deposit","deposit paid amount"] },
  { key:"depositPaidDate", label:"Deposit Date",    aliases:["deposit date","deposit paid date","date deposit paid"] },
  { key:"totalPaid",       label:"Final Paid",      aliases:["final paid","balance paid","final payment","final amt","final","balance"] },
  { key:"totalPaidDate",   label:"Final Date",      aliases:["final date","balance date","final paid date","date balance paid"] },
  { key:"leadCount",       label:"Leads",           aliases:["leads","lead count","leads collected","# leads"] },
  { key:"appointmentCount",label:"Appointments",    aliases:["appts","appt","appointments","set","appointments set"] },
  { key:"salesAmount",     label:"Sale Amount",     aliases:["sale amt","sales","sale amount","sales amount","sold amount","revenue"] },
  ...
  { key:"needToKnow",      label:"Notes",           aliases:["notes","need to know","comments","description","details","info","comments production"] },
];
    ...
    const imported = rows.map(row => {
      ...
      return {
        ...{ name:"", date:"", endDate:"", startTime:"", endTime:"", category:"", status:"lead",
             ...
             assignedEmployees:[], employeeReports:[], inventory:[], checklist:[], communications:[], documents:[], photos:[], payments:[], shifts:[], rating:null, ratingNotes:"" },
        id: genId(),
        name:         get("name"),
        ...
        depositPaid:     get("depositPaid").replace(/[$,]/g,""),
        depositPaidDate: parseImportDate(get("depositPaidDate")),
        totalPaid:       get("totalPaid").replace(/[$,]/g,""),
        totalPaidDate:   parseImportDate(get("totalPaidDate")),
        leadCount:        +(get("leadCount").replace(/[^0-9.]/g,"")) || 0,
        appointmentCount: +(get("appointmentCount").replace(/[^0-9.]/g,"")) || 0,
        salesAmount:      +(get("salesAmount").replace(/[$,]/g,"")) || 0,
        ...
        <div style={{ minHeight:"100vh", background:"#F7F2EB" }}>
          ...
          <EmployeePortalView
            ...
            onUpdateShow={async show => {
              ...
              if (error) console.error("Preview save error:", error);
            }}
